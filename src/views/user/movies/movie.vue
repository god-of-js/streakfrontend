  ...
  <div class="movie_page pt-4 no_overflow" :key="movie.videoUrl">
    <div class="movie_display m-3 mt-0  pl-0 pr-4 p-0 pb-3 no_overflow" >
        ...
        <div class="d-flex mb-2 pl-4 justify-content-between pr-4">
            ...
            <div class="title_view" ><button class="trans_btn small_icon"><i class="mdi mdi-thumb-up"> </i><span class="font_sm"> 900</span>  </button> <button class="trans_btn small_icon"><i class="mdi mdi-thumb-down"> </i> <span class="font_sm mb-2"> 900</span> </button>  </div>
        </div>
        <div class="text-left movie_description pl-5 col-10"> {{movie.description}}</div>
    </div>
    <div> 
        <div class="text-left pl-5 mr-5 pt-0 sub_heading">If you like {{$format(movie.title)}}, You would love:</div>
        <div class="row p-1 d-flex justify-content-center" :key="moviesCollection.length">
         <usermovie
